class Insured::GroupSelectionController < ApplicationController
  ...
  def create
    ...
    if (keep_existing_plan && @hbx_enrollment.present?)
      sep_id = @hbx_enrollment.is_shop? ? @hbx_enrollment.family.earliest_effective_shop_sep.nil? ? "" : @hbx_enrollment.family.earliest_effective_shop_sep.id : @hbx_enrollment.family.earliest_effective_ivl_sep.nil? ? "" : @hbx_enrollment.family.earliest_effective_ivl_sep.id
