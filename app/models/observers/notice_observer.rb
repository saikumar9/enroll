class Observers::NoticeObserver < Observers::Observer

  # TODO: Code below pulled from NoticeTrigger
  # Integrate here and delete NoticeTrigger
  # Why are these persisted in MongoDB?
