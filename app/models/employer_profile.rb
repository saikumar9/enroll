...
#  field :conversion_carrier_id, type: BSON::ObjectId, default: nil
  ...
  def hire_broker_agency(new_broker_agency, start_on = today)
    SponsoredBenefits::Organizations::BrokerAgencyProfile.create_plan_design_org(broker_agency: new_broker_agency, employer_profile: self, office_locations: parent.office_locations)
