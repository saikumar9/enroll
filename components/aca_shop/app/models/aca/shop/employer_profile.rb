module Aca
  module Shop
    class EmployerProfile
      ...
      # TODO: consolidate AASM common code
      include AASM
      include StateTransitionPublisher
      embeds_many :workflow_state_transitions, as: :transitional


      # TODO: Centralize notifications to one concern model set. 
      # Acapi talks to external systems. Limit models working with Acapi
