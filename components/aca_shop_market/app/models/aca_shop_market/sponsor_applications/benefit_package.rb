module Aca
  module Shop
    ...
    class BenefitPackage
      ...
      embedded_in :benefit_application, class_name: "Aca::Shop::BenefitApplication"
      ...
      delegate :market_places, :enrollment_periods, :family_relationships, :benefit_categories, 
               ...
               to: :member_eligible_for_product_policy
      ...
      embeds_one :member_eligible_for_product_policy
      accepts_nested_attributes_for :member_eligible_for_product_policy

      after_initialize :initialize_dependent_models

      def initialize_dependent_models
        build_member_eligible_for_product_policy if member_eligible_for_product_policy.nil?
      end
      ...
      # def initialize(*args)
      #   self.build_member_eligible_for_product_policy
      #   super(*args)
      # end
