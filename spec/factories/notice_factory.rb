FactoryGirl.define do
  factory :notices_employer_profile, class: EmployerProfile do
    ...
    organization { FactoryGirl.build(:notice_organization) }
  ...
  factory :notice_organization, class: Organization do
    ...
    before :create do |organization, evaluator|
      organization.employer_profile = FactoryGirl.create :notices_employer_profile, organization: organization
    end
  end
  ...
  factory :notice_benefit_group, class: BenefitGroup do
    ...
    default false
    reference_plan_id  Plan.find("59e8dc27db57802fec000366").id
