    ...
    trait :with_primary_family_member_and_dependent do
      family_members {
        [
          ...
          FactoryBot.build(:family_member, family: self, is_primary_applicant: false, is_active: true, person: Person.new(first_name: "John", last_name: "Doe")),
          FactoryBot.build(:family_member, family: self, is_primary_applicant: false, is_active: true, person: Person.new(first_name: "Alex", last_name: "Doe"))
        ]
      }
