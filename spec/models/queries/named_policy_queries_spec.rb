...
describe Queries::NamedPolicyQueries, "Policy Queries", dbclean: :after_each do
  ...
  context "Shop Monthly Queries" do
    ...
    let(:renewing_employees) {
      FactoryBot.create_list(:census_employee_with_active_and_renewal_assignment, 5, hired_on: (TimeKeeper.date_of_record - 2.years), employer_profile: renewing_employer,
