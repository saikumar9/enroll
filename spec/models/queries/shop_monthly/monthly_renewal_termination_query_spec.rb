  ...
  describe "given a renewing employer who has completed their open enrollment" do
    ...
    " do
      ...
      let(:renewing_employees) {
        FactoryBot.create_list(:census_employee_with_active_and_renewal_assignment, 4, hired_on: (TimeKeeper.date_of_record - 2.years), employer_profile: renewing_employer, 
