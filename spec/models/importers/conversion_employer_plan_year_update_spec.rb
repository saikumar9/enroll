...
#         FactoryBot.create(:plan, :with_premium_tables, coverage_kind: "health", active_year: 2015, renewal_plan_id: new_renewal_health_plan.id, carrier_profile_id: carrier_profile.id)
#       }
